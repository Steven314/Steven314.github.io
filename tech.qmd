...
I dabbled in [Neovim](https://neovim.io/) with [NvChad](https://nvchad.com/) for a while in 2024, but keeping [my setup](https://github.com/Steven314/nvim) up-to-date was somewhat tedious for my liking.
I also discovered that the company restrictions on my work laptop limited the use of [npm](https://www.npmjs.com/) meaning some plugins would not function properly.
